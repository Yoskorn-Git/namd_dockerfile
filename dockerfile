...
#Untar hpcx v2.6.0
RUN APP_MPI_PATH=/home/cluster/thor/application/mpi \
    HPCX_TAR=$HOME/code/hpcx-v2.6.0-gcc-MLNX_OFED_LINUX-4.7-1.0.0.1-redhat7.7-x86_64.tbz \
    bash -c '
RUN tar -xf $HPCX_TAR -C $APP_MPI_PATH ' 
